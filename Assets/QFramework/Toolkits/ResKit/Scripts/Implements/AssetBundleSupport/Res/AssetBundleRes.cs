...
namespace QFramework
{
    ...
    public class AssetBundleRes : Res
    {
        ...
        public override bool LoadSync()
        {
            ...
            {
                //Debug.Log("AssetsB 名字: " + mAssetName);
                //Debug.Log("AssetBundlePathHelper.SimulationModeAssetBundlePathHelper.SimulationModeAssetBundlePathHelper.SimulationModeAssetBundlePathHelper.SimulationModeAssetBundlePathHelper.SimulationMode");
            }
            else
            {
                ...
                {
                    Debug.Log("RRRRRRRRRRRRRRRRRRRRRRRRRRRR" + mAssetName);
                }
