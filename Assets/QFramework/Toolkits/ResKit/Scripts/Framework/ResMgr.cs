    ...
    public class ResMgr : MonoBehaviour, ISingleton
    {
        ...
        public IEnumerator InitResMgrAsync()
        {
            ...
            else
            {
                ...
                {
                    Debug.Log("NONONONONONONONONONONONONONONONONONONONONONONONONONONO");
                ...
                {
                    Debug.Log("YesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYes");
                    // var persistentPath = Application.persistentDataPath + "/AssetBundles/" +
                    //                      AssetBundlePathHelper.GetPlatformName() + "/" + ResDatas.FileName;
                    var persistentPath = Application.persistentDataPath + "/" + ResDatas.FileName;
        ...
        public void InitResMgr()
        {
            ...
            else
            {
                ...
                if (AssetBundleSettings.LoadAssetResFromStreamingAssetsPath)
                {
                    Debug.Log("InitResMgrONONONONONONONONONONONONONONONONONONONONONO");
                ...
                {
                    Debug.Log("InitResMgrYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYes");
